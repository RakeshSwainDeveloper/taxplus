...
<div class="itr-container">
    ...
    <!-- Header & Title -->
    <header class="itr-header text-center mb-12">
    ...
    <div id="step-2-content" class="space-y-8 hidden max-w-3xl mx-auto">
        ...
        <div class="flex justify-between pt-8">
            <button onclick="backToStep1()" class="px-6 py-2 text-sm font-medium text-gray-300 bg-gray-700 rounded-full hover:bg-gray-600 transition duration-200">
                &larr; Change Plan
            </button>
...
<script>
    ...
    // --- DOM Elements ---
    const steps = [
        { id: 1, content: document.getElementById('step-1-content'), indicator: document.getElementById('step-1-indicator') },
        { id: 2, content: document.getElementById('step-2-content'), indicator: document.getElementById('step-2-indicator') },
        { id: 3, content: document.getElementById('step-3-content'), indicator: document.getElementById('step-3-indicator') }
    ];
    ...
    function updateUI() {
        ...
        if (selectedDocumentMethod) {
            step2NextButton.classList.remove('btn-disabled');
            step2NextButton.disabled = false;
        } else {
            step2NextButton.classList.add('btn-disabled');
    ...
    function backToStep1() {
        selectedPlan = { id: null, name: null, price: null };
